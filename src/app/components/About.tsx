        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <div className="relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1737575655055-e3967cbefd03?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBkZXZlbG9wZXIlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NzQ1Mjc3MTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="Developer"
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              My journey in web development started with a curiosity for how websites work, and it has grown
              into a career where I get to solve complex problems and bring ideas to life through code.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
