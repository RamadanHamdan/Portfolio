  ...
  const projects = [
    {
      ...
      description: 'Company profile website for PT. Bahtera Arta Niaga.',
      image: 'src/assets/bahtera.png',
      tags: ['React', 'TypeScript', 'Tailwind CSS'],
      demo: 'https://www.bahteraartaniaga.com/',
    },
    {
      title: 'Responsive Website',
      description: 'Responsive website with image sequence animation.',
      image: 'src/assets/makjay.png',
      tags: ['React', 'TypeScript', 'Tailwind CSS'],
      demo: 'https://makjay.vercel.app/',
    },
    {
      title: 'WordPress Platform for SCM Racing',
      description: 'Custom WordPress platform for SCM Racing with integrated racing data and event management.',
      image: 'src/assets/scm.jpeg',
      tags: ['WordPress', 'PHP', 'MySQL'],
      github: 'https://github.com',
      demo: 'https://scm-racing.com/',
    },
    {
      title: 'CRM Super App',
      description: 'Customer Relationship Management (CRM) application for managing customer interactions and data.',
    ...
    {
      title: 'Apartement Unit Management',
      description: 'Web application for managing apartment units, tenants, and maintenance requests.',
